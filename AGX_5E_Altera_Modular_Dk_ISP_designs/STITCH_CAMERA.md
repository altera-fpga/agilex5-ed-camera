# 4Kp60 Multi-Sensor Camera Stitch Solution System Example Design for Agilex™ 5 Devices - Repository
...
[Refer to the main documentation for additional licensing information](../docs/camera/camera_4k_stitch/camera_4k_stitch.md)
...
The [**Software flow**](./../sw/README.md#4kp60-multi-sensor-camera-stitch-solution-system-example-design-for-agilex-5-devices)
...
Quartus® project for the 4Kp60 Multi-Sensor Camera Stitch Solution System
Example Design. Note, a pregenerated Quartus® project (using the MDT flow) is
also provided for standard compilation flow.
...
### Creating and compiling the 4Kp60 Multi-Sensor Camera Stitch Solution System Example Design
...
quartus_sh -t ./modular-design-toolkit/scripts/create/create_shell.tcl -proj_path <project> -proj_name agilex5_modkit_vvpisp -xml_path ./AGX_5E_Altera_Modular_Dk_ISP_designs/AGX_5E_Modular_Devkit_ISP_Stitch_FF_RD.xml
```

```bash
# RBF MDT Flow (not supported with OCP evaluation license)
cd agilex5-ed-camera
quartus_sh -t ./modular-design-toolkit/scripts/create/create_shell.tcl -proj_path <project> -proj_name agilex5_modkit_vvpisp -xml_path ./AGX_5E_Altera_Modular_Dk_ISP_designs/AGX_5E_Modular_Devkit_ISP_Stitch_RD.xml
```
...
Designer Project for the 4Kp60 Multi-Sensor Camera Stitch Solution System
Example Design:

* Define a `./<project>` location of your choice, creating directory structure
  where necessary.
* Download [AGX_5E_Modular_Devkit_ISP_Stitch_RD.zip](https://github.com/altera-fpga/agilex5-ed-camera/releases/download/rel-26.1/AGX_5E_Modular_Devkit_ISP_Stitch_RD.zip)
  and copy it to your `./<project>` location.
* Navigate to the `./<project>` location, extract the project, and load Quartus® GUI:

```bash
unzip AGX_5E_Modular_Devkit_ISP_Stitch_RD.zip

    AGX_5E_Modular_Devkit_ISP_Stitch_RD/
...
cd AGX_5E_Modular_Devkit_ISP_Stitch_RD
...
Follow the next steps to build the 4Kp60 Multi-Sensor Camera Stitch Solution
...
* For SOF MDT Flow [Refer to the main documentation for more details](../docs/camera/camera_4k_stitch/flow2-sof-mdt.md):
  * `fsbl_agilex5_modkit_vvpisp_time_limited.sof`
* For RBF MDT Flow [Refer to the main documentation for more details](../docs/camera/camera_4k_stitch/flow3-rbf-mdt.md):
...
the 4Kp60 Multi-Sensor Camera Stitch Solution System Example Design allowing
you to view extra information such as resource utilization and timing reports:

* Using Quartus® GUI:

```bash
cd ./<project>/AGX_5E_Modular_Devkit_ISP_Stitch_RD
quartus agilex5_modkit_vvpisp.qpf
```
...
* For full license, the patch will generate a `.jic` for the QSPI flash and an
  ...
  [Refer to the main documentation for more details](../docs/camera/camera_4k_stitch/flow3-rbf-mdt.md).
...
`./<project>/AGX_5E_Modular_Devkit_ISP_Stitch_RD/output_files` directory:
...
* For a time limited Open Core Plus license, the `.sof` is patched to create a
  ...
  [Refer to the main documentation for more details](../docs/camera/camera_4k_stitch/flow2-sof-mdt.md).
...
## Running the 4Kp60 Multi-Sensor Camera Stitch Solution System Example Design

[Refer to the main documentation](../docs/camera/camera_4k_stitch/camera_4k_stitch.md)
