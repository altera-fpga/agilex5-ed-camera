# 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices - Repository

## Overview

The repository contains the necessary files and collateral to create and build
the 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example
Design.
...
[Refer to the main documentation for additional licensing information](../docs/camera/camera_4k_ai_warp/camera_4k_ai_warp.md)
...
Quartus® project for the 4K Multi-Sensor Fisheye Camera with AI Inference
Solution System Example Design. Note, a pregenerated Quartus® project (using
the MDT flow) is also provided for standard compilation flow.
...
### Creating and compiling the 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design
...
quartus_sh -t fpga_ai_suite_prerequisite.tcl
. setenv.sh
```
...
Designer Project for the 4K Multi-Sensor Fisheye Camera with AI Inference
...
Follow the next steps to build the 4K Multi-Sensor Fisheye Camera with AI
Inference Solution System Example Design:
...
* For SOF MDT Flow [Refer to the main documentation for more details](../docs/camera/camera_4k_ai_warp/flow2-sof-mdt.md):
  * `fsbl_agilex5_modkit_vvpisp_time_limited.sof`
* For RBF MDT Flow [Refer to the main documentation for more details](../docs/camera/camera_4k_ai_warp/flow3-rbf-mdt.md):
...
the 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example
Design allowing you to view extra information such as resource utilization and
timing reports:
...
* For full license, the patch will generate a `.jic` for the QSPI flash and an
  ...
  [Refer to the main documentation for more details](../docs/camera/camera_4k_ai_warp/flow3-rbf-mdt.md).
...
* For a time limited Open Core Plus license, the `.sof` is patched to create a
  ...
  [Refer to the main documentation for more details](../docs/camera/camera_4k_ai_warp/flow2-sof-mdt.md).
...
## Running the 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design

[Refer to the main documentation](../docs/camera/camera_4k_ai_warp/camera_4k_ai_warp.md)
