...
proc apply_all_cdc {} {
  ...
  # agent_clk -> main_clk
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_drm_adapter_cpu|r_cpu_control[*]"] [get_keepers -nowarn "$inst|u_altera_vvp_drm_adapter_cpu|r_cpu_control_meta[*]"] 1
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_drm_adapter_cpu|r_cpu_control[*]*"] [get_keepers -nowarn "$inst|u_altera_vvp_drm_adapter_cpu|r_cpu_control_meta[*]"] 1
