...
# Module Properties
############################################################################
set_module_property DISPLAY_NAME                 "DRM Control"
set_module_property DESCRIPTION                  "Converts Direct Rendering Manager formatted data to VVP Lite"
set_module_property NAME                         altera_vvp_drm_adapter
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL altera_vvp_drm_adapter_core
add_fileset_file  src_hdl/altera_vvp_drm_adapter_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_drm_adapter_cpu.sv
add_fileset_file  src_hdl/altera_vvp_drm_adapter_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_drm_adapter_gen.sv
add_fileset_file  src_hdl/altera_vvp_drm_adapter_core.sv    SYSTEM_VERILOG PATH \
                                                              src_hdl/altera_vvp_drm_adapter_core.sv   TOP_LEVEL_FILE
add_fileset_file  altera_vvp_drm_adapter.sdc                SDC_ENTITY      PATH \
                                                              altera_vvp_drm_adapter.sdc {NO_SDC_PROMOTION}

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL altera_vvp_drm_adapter_core
add_fileset_file  src_hdl/altera_vvp_drm_adapter_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_drm_adapter_cpu.sv
add_fileset_file  src_hdl/altera_vvp_drm_adapter_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_drm_adapter_gen.sv
add_fileset_file  src_hdl/altera_vvp_drm_adapter_core.sv    SYSTEM_VERILOG PATH \
                                                              src_hdl/altera_vvp_drm_adapter_core.sv   TOP_LEVEL_FILE
...
set_fileset_property SIM_VHDL TOP_LEVEL altera_vvp_drm_adapter_core
add_fileset_file  src_hdl/altera_vvp_drm_adapter_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_drm_adapter_cpu.sv
add_fileset_file  src_hdl/altera_vvp_drm_adapter_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_drm_adapter_gen.sv
add_fileset_file  src_hdl/altera_vvp_drm_adapter_core.sv    SYSTEM_VERILOG PATH \
                                                              src_hdl/altera_vvp_drm_adapter_core.sv   TOP_LEVEL_FILE
...
set_parameter_property    RUNTIME_CONTROL           ENABLED             false
...
set_parameter_property    C_CPU_OFFSET              ENABLED             false

add_parameter             NUMBER_OF_COLOR_PLANES    INTEGER             4
...
set_parameter_property    NUMBER_OF_COLOR_PLANES    DESCRIPTION         "1 to 4 Colour Planes."
...
set_parameter_property    PIXELS_IN_PARALLEL        ALLOWED_RANGES      {"1" "2"}
...
set_parameter_property    PIXELS_IN_PARALLEL        DESCRIPTION         "1, 2 Pixels processed in parallel."
...
add_parameter             BPS_OUT                   INTEGER             10
...
set_parameter_property    BPS_OUT                   DISPLAY_NAME        "Input Colour Depth"
...
omni_add_capability 601 1 64 0 0
...
proc elaboration_callback {} {
  ...
  set v_s_vid_axis_tdata_width  [expr ( ( ${v_num_color_planes} * ${v_bits_per_color_in} +7)/8*8) * ${v_num_pip}]
  set v_s_vid_axis_tuser_width  [expr ( ( ${v_num_color_planes} * ${v_bits_per_color_in} +7)/8) * ${v_num_pip}]

  set v_m_vid_axis_tdata_width  [expr ( ( ${v_num_color_planes} * ${v_bits_per_color_out} +7)/8*8) * ${v_num_pip}]
  set v_m_vid_axis_tuser_width  [expr ( ( ${v_num_color_planes} * ${v_bits_per_color_out} +7)/8) * ${v_num_pip}]
