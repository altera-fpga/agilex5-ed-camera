...
proc apply_all_cdc {} {
  ...
  # agent_clk -> main_clk
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_cpu_control[*]"] [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_vid_control_meta[*]"] 1
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_cpu_control[*]*"] [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_vid_control_meta[*]"] 1
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_cpu_h_control[*]"] [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_vid_h_control_meta[*]"] 1
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_cpu_h_control[*]*"] [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_vid_h_control_meta[*]"] 1
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_cpu_v_control[*]"] [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_vid_v_control_meta[*]"] 1
  apply_cdc  [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_cpu_v_control[*]*"] [get_keepers -nowarn "$inst|u_altera_vvp_roi_cpu|r_vid_v_control_meta[*]"] 1
}
