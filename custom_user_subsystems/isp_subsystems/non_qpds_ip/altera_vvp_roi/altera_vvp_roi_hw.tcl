...
# Module Properties
############################################################################
set_module_property DISPLAY_NAME                 "Region Of Interest"
set_module_property DESCRIPTION                  "Highlights a Region Of Interest"
set_module_property NAME                         altera_vvp_roi
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL altera_vvp_roi_core
add_fileset_file  src_hdl/altera_vvp_roi_en.sv      SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_en.sv
add_fileset_file  src_hdl/altera_vvp_roi_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_cpu.sv
add_fileset_file  src_hdl/altera_vvp_roi_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_gen.sv
add_fileset_file  src_hdl/altera_vvp_roi_core.sv    SYSTEM_VERILOG PATH \
                                                              src_hdl/altera_vvp_roi_core.sv   TOP_LEVEL_FILE
add_fileset_file  altera_vvp_roi.sdc                SDC_ENTITY      PATH \
                                                              altera_vvp_roi.sdc {NO_SDC_PROMOTION}

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL altera_vvp_roi_core
add_fileset_file  src_hdl/altera_vvp_roi_en.sv      SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_en.sv
add_fileset_file  src_hdl/altera_vvp_roi_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_cpu.sv
add_fileset_file  src_hdl/altera_vvp_roi_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_gen.sv
add_fileset_file  src_hdl/altera_vvp_roi_core.sv    SYSTEM_VERILOG PATH \
...
set_fileset_property SIM_VHDL TOP_LEVEL altera_vvp_roi_core
add_fileset_file  src_hdl/altera_vvp_roi_en.sv      SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_en.sv
add_fileset_file  src_hdl/altera_vvp_roi_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_cpu.sv
add_fileset_file  src_hdl/altera_vvp_roi_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_roi_gen.sv
add_fileset_file  src_hdl/altera_vvp_roi_core.sv    SYSTEM_VERILOG PATH \
...
set_parameter_property    BPS                       ENABLED             true
...
omni_add_capability 600 1 64 0 0
...
proc elaboration_callback {} {
  ...
  set v_m_vid_axis_tdata_width  [expr ( ( ${v_num_color_planes} * ${v_bits_per_color} +7)/8*8) * ${v_num_pip}]
  set v_m_vid_axis_tuser_width  [expr ( ( ${v_num_color_planes} * ${v_bits_per_color} +7)/8) * ${v_num_pip}]
