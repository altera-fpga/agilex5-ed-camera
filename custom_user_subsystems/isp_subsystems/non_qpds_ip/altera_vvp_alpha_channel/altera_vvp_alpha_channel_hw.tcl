...
# Module Properties
############################################################################
set_module_property DISPLAY_NAME                 "Alpha Channel"
set_module_property DESCRIPTION                  "Adds an Alpha Channel to RGB video based on a programmable Table"
set_module_property NAME                         altera_vvp_alpha_channel
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL altera_vvp_alpha_channel_core
add_fileset_file  src_hdl/altera_vvp_alpha_channel_lut.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_lut.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_cpu.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_gen.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_core.sv    SYSTEM_VERILOG PATH \
                                                              src_hdl/altera_vvp_alpha_channel_core.sv   TOP_LEVEL_FILE
add_fileset_file  altera_vvp_alpha_channel.sdc                SDC_ENTITY      PATH \
                                                              altera_vvp_alpha_channel.sdc {NO_SDC_PROMOTION}

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL altera_vvp_alpha_channel_core
add_fileset_file  src_hdl/altera_vvp_alpha_channel_lut.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_lut.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_cpu.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_gen.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_core.sv    SYSTEM_VERILOG PATH \
...
set_fileset_property SIM_VHDL TOP_LEVEL altera_vvp_alpha_channel_core
add_fileset_file  src_hdl/altera_vvp_alpha_channel_lut.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_lut.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_cpu.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_cpu.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_gen.sv     SYSTEM_VERILOG PATH   src_hdl/altera_vvp_alpha_channel_gen.sv
add_fileset_file  src_hdl/altera_vvp_alpha_channel_core.sv    SYSTEM_VERILOG PATH \
...
set_parameter_property    BPS                       ENABLED             false
...
omni_add_capability 599 1 64 0 0
...
proc elaboration_callback {} {
  ...
  set v_m_vid_axis_tdata_width  [expr ( ( (${v_num_color_planes} +1) * ${v_bits_per_color} +7)/8*8) * ${v_num_pip}]
  set v_m_vid_axis_tuser_width  [expr ( ( (${v_num_color_planes} +1) * ${v_bits_per_color} +7)/8) * ${v_num_pip}]
