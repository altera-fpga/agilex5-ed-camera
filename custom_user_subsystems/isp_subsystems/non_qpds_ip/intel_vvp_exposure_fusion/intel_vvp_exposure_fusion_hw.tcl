...
# Module Properties
############################################################################
set_module_property DISPLAY_NAME                 "Exposure Fusion"
set_module_property DESCRIPTION                  "Exposure Fusion for combining short and long exposures"
set_module_property NAME                         intel_vvp_exposure_fusion
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL intel_vvp_exposure_fusion_core
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_shim.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_shim.sv
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_buff.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_buff.sv
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_cpu.sv    SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_cpu.sv
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_gen.sv    SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_gen.sv
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_core.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_core.sv   TOP_LEVEL_FILE
add_fileset_file   intel_vvp_exposure_fusion.sdc               SDC_ENTITY \
                                PATH   intel_vvp_exposure_fusion.sdc {NO_SDC_PROMOTION}

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL intel_vvp_exposure_fusion_core
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_shim.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_shim.sv
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_buff.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_buff.sv
...
set_fileset_property SIM_VHDL TOP_LEVEL intel_vvp_exposure_fusion_core
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_shim.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_shim.sv
add_fileset_file   src_hdl/intel_vvp_exposure_fusion_buff.sv   SYSTEM_VERILOG \
                                PATH   src_hdl/intel_vvp_exposure_fusion_buff.sv
...
set_parameter_property        C_CPU_OFFSET              ALLOWED_RANGES        0:60
set_parameter_property        C_CPU_OFFSET              DISPLAY_UNITS         {[0 - 60] Registers}
...
add_parameter                 NUMBER_OF_COLOR_PLANES    INTEGER               1
set_parameter_property        NUMBER_OF_COLOR_PLANES    ALLOWED_RANGES        1:1
...
set_parameter_property        NUMBER_OF_COLOR_PLANES    DESCRIPTION           "Only supports 1 colour plane"
...
set_parameter_property        PIXELS_IN_PARALLEL        DESCRIPTION \
                                                                  "1, 2, 4, or 8 Pixels processed in parallel."
set_parameter_property        PIXELS_IN_PARALLEL        AFFECTS_ELABORATION   true

add_parameter                 BPS_IN                    INTEGER               12
set_parameter_property        BPS_IN                    ALLOWED_RANGES        8:16
set_parameter_property        BPS_IN                    DISPLAY_UNITS         {[8 - 16] bits}
set_parameter_property        BPS_IN                    HDL_PARAMETER         true
set_parameter_property        BPS_IN                    DISPLAY_NAME          "Input Colour Depth"
set_parameter_property        BPS_IN                    DESCRIPTION           "8 to 16 bits."
set_parameter_property        BPS_IN                    AFFECTS_ELABORATION   true

add_parameter                 BPS_OUT                   INTEGER               16
set_parameter_property        BPS_OUT                   ALLOWED_RANGES        8:16
set_parameter_property        BPS_OUT                   DISPLAY_UNITS         {[8 - 16] bits}
set_parameter_property        BPS_OUT                   HDL_PARAMETER         true
set_parameter_property        BPS_OUT                   DISPLAY_NAME          "Output Colour Depth"
set_parameter_property        BPS_OUT                   DESCRIPTION           "8 to 16 bits."
set_parameter_property        BPS_OUT                   AFFECTS_ELABORATION   true

add_parameter                 C_OUTPUT_MODE             INTEGER               3
set_parameter_property        C_OUTPUT_MODE             ALLOWED_RANGES        0:3
set_parameter_property        C_OUTPUT_MODE             HDL_PARAMETER         true
set_parameter_property        C_OUTPUT_MODE             DISPLAY_NAME          "Output select"
set_parameter_property        C_OUTPUT_MODE             DESCRIPTION \
                                      "0: exposure fusion, 1: short exposure, 2: reserved, 3: long exposure"
set_parameter_property        C_OUTPUT_MODE             AFFECTS_ELABORATION   false

add_parameter                 C_BLACK_LEVEL             INTEGER               200
set_parameter_property        C_BLACK_LEVEL             ALLOWED_RANGES        0:65535
set_parameter_property        C_BLACK_LEVEL             HDL_PARAMETER         true
set_parameter_property        C_BLACK_LEVEL             DISPLAY_NAME          "Black Level"
set_parameter_property        C_BLACK_LEVEL             DESCRIPTION           "Black level of the inputs"
set_parameter_property        C_BLACK_LEVEL             AFFECTS_ELABORATION   false

add_parameter                 C_EXPOSURE_RATIO          INTEGER               10802
set_parameter_property        C_EXPOSURE_RATIO          ALLOWED_RANGES        1:131071
set_parameter_property        C_EXPOSURE_RATIO          HDL_PARAMETER         true
set_parameter_property        C_EXPOSURE_RATIO          DISPLAY_NAME          "Exposure Ratio"
set_parameter_property        C_EXPOSURE_RATIO          DESCRIPTION \
                                                "0.17 bits fixed point fractional short/long exposure ratio"
set_parameter_property        C_EXPOSURE_RATIO          AFFECTS_ELABORATION   false

add_parameter                 C_THRESHOLD               INTEGER               4437
set_parameter_property        C_THRESHOLD               ALLOWED_RANGES        0:65535
set_parameter_property        C_THRESHOLD               HDL_PARAMETER         true
set_parameter_property        C_THRESHOLD               DISPLAY_NAME          "Threshold"
set_parameter_property        C_THRESHOLD               DESCRIPTION \
                                                "The IP starts blending exposures over the threshold value"
set_parameter_property        C_THRESHOLD               AFFECTS_ELABORATION   false
...
add_display_item        "Parameters"            C_OUTPUT_MODE           parameter
add_display_item        "Parameters"            C_BLACK_LEVEL           parameter
add_display_item        "Parameters"            C_EXPOSURE_RATIO        parameter
add_display_item        "Parameters"            C_THRESHOLD             parameter


omni_add_capability 597 1 64 0 0
...
add_interface            axi4s_vid_in_0     axi4stream             end
set_interface_property   axi4s_vid_in_0     associatedClock        main_clock
set_interface_property   axi4s_vid_in_0     associatedReset        main_reset
add_interface_port       axi4s_vid_in_0     axi4s_vid_in_0_tvalid  tvalid      Input    1
add_interface_port       axi4s_vid_in_0     axi4s_vid_in_0_tready  tready      Output   1
add_interface_port       axi4s_vid_in_0     axi4s_vid_in_0_tlast   tlast       Input    1

add_interface            axi4s_vid_in_1     axi4stream             end
set_interface_property   axi4s_vid_in_1     associatedClock        main_clock
set_interface_property   axi4s_vid_in_1     associatedReset        main_reset
add_interface_port       axi4s_vid_in_1     axi4s_vid_in_1_tvalid  tvalid      Input    1
add_interface_port       axi4s_vid_in_1     axi4s_vid_in_1_tready  tready      Output   1
add_interface_port       axi4s_vid_in_1     axi4s_vid_in_1_tlast   tlast       Input    1
...
proc elaboration_callback {} {
  ...
  set v_bps_in              [ get_parameter_value   BPS_IN ]
  set v_bps_out             [ get_parameter_value   BPS_OUT ]

  set v_vid_axis_in_tdata_width   [expr ( ( ${v_num_color_planes} * ${v_bps_in} +7)/8*8) * ${v_num_pip}]
  set v_vid_axis_out_tdata_width  [expr ( ( ${v_num_color_planes} * ${v_bps_out} +7)/8*8) * ${v_num_pip}]
  set v_vid_axis_in_tuser_width   [expr ( ( ${v_num_color_planes} * ${v_bps_in} +7)/8) * ${v_num_pip}]
  set v_vid_axis_out_tuser_width  [expr ( ( ${v_num_color_planes} * ${v_bps_out} +7)/8) * ${v_num_pip}]

  add_interface_port   axi4s_vid_in_0   axi4s_vid_in_0_tuser    tuser   Input    ${v_vid_axis_in_tuser_width}
  add_interface_port   axi4s_vid_in_0   axi4s_vid_in_0_tdata    tdata   Input    ${v_vid_axis_in_tdata_width}
  add_interface_port   axi4s_vid_in_1   axi4s_vid_in_1_tuser    tuser   Input    ${v_vid_axis_in_tuser_width}
  add_interface_port   axi4s_vid_in_1   axi4s_vid_in_1_tdata    tdata   Input    ${v_vid_axis_in_tdata_width}

  add_interface_port   axi4s_vid_out    axi4s_vid_out_tuser   tuser   Output   ${v_vid_axis_out_tuser_width}
  add_interface_port   axi4s_vid_out    axi4s_vid_out_tdata   tdata   Output   ${v_vid_axis_out_tdata_width}
