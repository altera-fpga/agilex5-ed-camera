...
The 4Kp30 Multi-Sensor Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices demonstrates a practical glass-to-glass
...
> **-** If you want to just explore the Quartus® Project for [User Flow 2],
        follow [SOF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt). <br/>
> **-** If you want to build your own binaries from source using Quartus® with
...
> **-** If you want to just explore the Quartus® Project for [User Flow 3],
        follow [RBF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt). <br/>
> **-** If you want to just explore the Quartus® Project, follow [User Flow 4],
        (specifically [Quartus® GUI Create Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_CAMERA.md#using-the-pregenerated-mdt-quartus-project)). <br/><br/>
...
|-|-|-|
| Assets Release Tag | [Release Tag](https://github.com/altera-fpga/agilex5-ed-camera/releases/tag/rel-26.1-isp_ai-MDK_RevB_GrpB) | rel/26.1 |
...
**Recommended User Flows**
 ...
 | --------- | --------- |:---------:|:---------:|:---------:|:---------:|
 | Pre-requisites | Hardware Requirements | [&check;](../camera_4k_ai/camera_4k_ai.md#hardware-requirements) | [&check;](../camera_4k_ai/flow2-sof-mdt.md#hardware-requirements) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#hardware-requirements) | &cross; |
 | | Software Requirements to build. | &cross; | [&check;](../camera_4k_ai/flow2-sof-mdt.md#software-requirements-to-build) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#software-requirements-to-build) | [&check;](../camera_4k_ai/flow4.md#software-requirements-to-build) |
 | | License Requirements to build. | &cross; | [&check;](../camera_4k_ai/flow2-sof-mdt.md#license-requirements-to-build) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#license-requirements-to-build) | [&check;](../camera_4k_ai/flow4.md#license-requirements-to-build) |
 ...
 | Programming | Setting Up the Development Kit | [&check;](../camera_4k_ai/camera_4k_ai.md#setting-up-the-development-kit) | [&check;](../camera_4k_ai/flow2-sof-mdt.md#setting-up-the-development-kit) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#setting-up-the-development-kit) | &cross; |
 | | Burn the microSD card image. | [&check;](../camera_4k_ai/camera_4k_ai.md#burn-the-microsd-card-image) | [&check;](../camera_4k_ai/flow2-sof-mdt.md#burn-the-microsd-card-image) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#burn-the-microsd-card-image) | &cross; |
 | | Copying the Compiled AI Models to the microSD Card | [&check;](../camera_4k_ai/camera_4k_ai.md#copying-the-compiled-ai-models-to-the-microsd-card) | [&check;](../camera_4k_ai/flow2-sof-mdt.md#copying-the-compiled-ai-models-to-the-microsd-card) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#copying-the-compiled-ai-models-to-the-microsd-card) | &cross; |
 | | Program the QSPI Flash Memory | [&check;](../camera_4k_ai/camera_4k_ai.md#program-the-qspi-flash-memory) | &cross; | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#program-the-qspi-flash-memory) | &cross; |
 | Running | Setting Up the Camera Solution | [&check;](../camera_4k_ai/camera_4k_ai.md#setting-up-the-camera-solution) | [&check;](../camera_4k_ai/flow2-sof-mdt.md#setting-up-the-camera-solution) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#setting-up-the-camera-solution) | &cross; |
 | | Program the FPGA SOF | &cross; | [&check;](../camera_4k_ai/flow2-sof-mdt.md#program-the-fpga-sof) | &cross; | &cross; |
 | | Connecting with a Web Browser | [&check;](../camera_4k_ai/camera_4k_ai.md#connecting-with-a-web-browser) | [&check;](../camera_4k_ai/flow2-sof-mdt.md#connecting-with-a-web-browser) | [&check;](../camera_4k_ai/flow3-rbf-mdt.md#connecting-with-a-web-browser) | &cross; |
