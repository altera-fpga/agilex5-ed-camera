...
| Boot Source | Link |
| ---------------------------------- | ---- |
| Pre-built microSD Card Image for SOF MDT Flow | [fpga-first-vvp-isp-demo-image-agilex5_mk_a5e065bb32aea.wic.gz] |
...
> **Note** <br/>
> use **KAS_MACHINE=agilex5_mk_a5e065bb32aea** and
