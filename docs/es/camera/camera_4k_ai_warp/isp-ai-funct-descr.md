...
# 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices - AI Software Design Functional Description

## Overview
The 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example
Design uses the FPGA AI Suite IP to run inferences on live video data. The
video input is streamed to the FPGA AI Suite IP to perform an inference on each
frame.
