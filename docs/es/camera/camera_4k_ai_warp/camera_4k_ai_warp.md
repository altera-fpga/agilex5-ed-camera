...
# 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices
...
The 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices demonstrates a practical glass-to-glass
smart camera solution. The exclusive support for industry-standard MIPI (Mobile
Industry Processor Interface) D-PHY and MIPI CSI-2 interface on Agilex™ 5
FPGAs, along with Altera®'s FPGA AI Suite, provides a powerful tool for smart
camera product development.

| |<center markdown="1">An example of fisheye input</center>| |
|-|-|-|
| ![b](./images/AI/blank.png) | ![Fisheye input example](./images/AI/warp_input.jpg) | ![b](./images/AI/blank.png) |

|<center markdown="1">An example of AI Detect</center>|<center markdown="1">An example of AI Pose</center>|
|-|-|
| ![Detect example](./images/AI/warp_detect.jpg) | ![POSE example](./images/AI/warp_pose.jpg) |
...
camera use cases. In the 4K Multi-Sensor Camera with AI Inference Solution
...
processed into RGB video data. The backend of the ISP pipeline feeds a high
performance Warp IP core for geometric distortion correction of extreme fisheye
lens allowing for a near 360° field of view. The corrected output is passed to
the AI pipeline which consists of many VVP IP cores to buffer, format, and
scale the video suitable for AI processing. The backend of the AI pipeline
drives the resulting 4K streaming video output data (complete with AI inference
...
![VVP_ISP_AI_ED_Top_level](../camera_4k_resources/images/VVP_ISP_AI_ED_Top_level.png)

**High-Level Block Diagram of the Fisheye Camera with AI Inference Solution System Example Design**
</center>
<br/>
...
> **-** If you want to just explore the Quartus® Project for [User Flow 2],
        follow [SOF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt). <br/>
> **-** If you want to build your own binaries from source using Quartus® with
...
> **-** If you want to just explore the Quartus® Project for [User Flow 3],
        follow [RBF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt). <br/>
> **-** If you want to just explore the Quartus® Project, follow [User Flow 4],
        (specifically [Quartus® GUI Create Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#using-the-pregenerated-mdt-quartus-project)). <br/><br/>
...
* Make the required connections between the Host PC and the
  ...
  [**Setting Up the Modular Development Kit**](../camera_4k_ai_warp/camera_4k_ai_warp.md#programming).
...
|-|-|-|
| Assets Release Tag | [Release Tag](https://github.com/altera-fpga/agilex5-ed-camera/releases/tag/rel-26.1-isp_ai_warp-MDK_RevB_GrpB) | rel/26.1 |
...
* [User Flow 2]: Use the [SOF Modular Design Toolkit (MDT) Create Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt) and
  [SOF Modular Design Toolkit (MDT) Build Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#build-the-design-using-the-modular-design-toolkit-mdt) - typically used for Quartus®
...
* [User Flow 3]: Use the [RBF Modular Design Toolkit (MDT) Create Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt) and
  [RBF Modular Design Toolkit (MDT) Build Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#build-the-design-using-the-modular-design-toolkit-mdt) - typically used for Quartus®
  with full IP License for turnkey microSD card camera solutions. Supports the
  full and free FPGA AI Suite license.
* [User Flow 4]: Use the [Quartus® GUI Create Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#using-the-pregenerated-mdt-quartus-project) and
  [Quartus® GUI Build Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AI_WARP_CAMERA.md#building-the-pregenerated-mdt-quartus-project) - typically used to explore the Camera solution.
...
**Recommended User Flows**
 ...
 | --------- | --------- |:---------:|:---------:|:---------:|:---------:|
 | Pre-requisites | Hardware Requirements | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#hardware-requirements) | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#hardware-requirements) | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#hardware-requirements) | &cross; |
 | | Software Requirements to build. | &cross; | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#software-requirements-to-build) | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#software-requirements-to-build) | [&check;](../camera_4k_ai_warp/flow4.md#software-requirements-to-build) |
 | | License Requirements to build. | &cross; | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#license-requirements-to-build) | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#license-requirements-to-build) | [&check;](../camera_4k_ai_warp/flow4.md#license-requirements-to-build) |
 | | Software Requirements to run | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#software-requirements-to-run) | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#software-requirements-to-run) | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#software-requirements-to-run) | &cross; |
 | | Download and Compile the AI Models | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#download-and-compile-the-ai-models) | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#download-and-compile-the-ai-models) |[&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#download-and-compile-the-ai-models) | &cross; |
 | | Download the Pre-built Binaries | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#download-the-pre-built-binaries) | &cross; |&cross; | &cross; |
 ...
 | | Program the QSPI Flash Memory | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#program-the-qspi-flash-memory) | &cross; | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#program-the-qspi-flash-memory) | &cross; |
 | Running | Setting Up the Camera Solution | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#setting-up-the-camera-solution) | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#setting-up-the-camera-solution) | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#setting-up-the-camera-solution) | &cross; |
 | | Program the FPGA SOF | &cross; | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#program-the-fpga-sof) | &cross; | &cross; |
 | | Connecting with a Web Browser | [&check;](../camera_4k_ai_warp/camera_4k_ai_warp.md#connecting-with-a-web-browser) | [&check;](../camera_4k_ai_warp/flow2-sof-mdt.md#connecting-with-a-web-browser) | [&check;](../camera_4k_ai_warp/flow3-rbf-mdt.md#connecting-with-a-web-browser) | &cross; |
