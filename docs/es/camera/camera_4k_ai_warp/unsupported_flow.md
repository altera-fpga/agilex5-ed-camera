...
# 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices - Unsupported Flow

**This flow is no longer supported as the [Agilex™ 5 FPGA E-Series 065B Modular Development Kit]
is Discontinued**
