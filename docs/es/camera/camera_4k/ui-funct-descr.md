...
![InputConfigTab.](../camera_4k/images/SW/InputConfigTab.png)
...
![InputSelect.](../camera_4k/images/SW/InputSelect.png)
...
input. It can be used to verify the system with or without sensor modules.
...
Thsi input can be used to verify the system with or without sensor modules.
...
![ISPPipeline.](../camera_4k/images/SW/IspPipelineTab.png)
...
![OutputConfigTab.](../camera_4k/images/SW/OutputConfigTab.png)
...
![1DLUT-3DLUT-3DLUT.](../camera_4k_resources/images/SW/1DLUT-3DLUT-3DLUT.png)
...
![FrameWriter.](../camera_4k_resources/images/SW/FrameWriter.png)
...
image or the final processed output image post final Gamma 1D LUT. Clicking Raw
Camera Snapshot or ISP Output Snapshot, captures a single image from the input
or output of the video pipeline, respectively. The Download Image button allows
you to download a 48-bit MSB-aligned RGB TIFF image to the device running the
Web browser.
<br/>

Note that the monitor output may flicker while the image capture is in progress
and the GUI may become unresponsive for a moment. A popup notification
indicates that the application software has finished the capture process, and
that the image is ready for download.
...
![PipelineStatisticsTab.](../camera_4k/images/SW/PipelineStatisticsTab.png)
