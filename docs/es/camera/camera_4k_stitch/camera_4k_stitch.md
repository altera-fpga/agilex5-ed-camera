...
* Alternative Mount Option:
  ...
  * 2 [Tripod]/s.
  * [Alternative Tripod]/s.
* 2 Framos cables for PixelMate MIPI-CSI-2 (for Modular Development Kit connection):
  * [150mm flex-cable].
* (Optional) 2 [Framos GMSL3 5m] of which 1 requires [GMSL Modification](../common/gmsl-mod.md)
  * If using the Multi-Camera Tripod Mount Adapter:
    * 2 extra Framos cables for PixelMate MIPI-CSI-2 (between Camera Module and GMSL Serializer):
      * [150mm flex-cable].
...
|-|-|-|
| Assets Release Tag | [Release Tag](https://github.com/altera-fpga/agilex5-ed-camera/releases/tag/rel-26.1-isp_stitch-MDK_RevB_GrpB) | rel/26.1 |
...
* [User Flow 2]: Use the [SOF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/STITCH_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt) - typically
  used for Quartus® with OpenCore Plus IP Evaluation License for time limited
  and tethered camera solutions.
* [User Flow 3]: Use the [RBF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/STITCH_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt) - typically
...
**Recommended User Flows**
 ...
 | HW-Compilation | Creating and Building the Design based on the [SOF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/STITCH_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt) | &cross; | &check; | &cross; | &cross; |
 | | Creating and Building the Design based on the [RBF Modular Design Toolkit (MDT) Flow](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/STITCH_CAMERA.md#create-the-design-using-the-modular-design-toolkit-mdt) | &cross; | &cross; | &check; | &cross; |
