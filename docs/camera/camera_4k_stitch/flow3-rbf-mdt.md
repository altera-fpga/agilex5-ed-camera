...
# 4Kp60 Multi-Sensor Camera Stitch Solution System Example Design for Agilex™ 5 Devices - RBF Modular Design Toolkit (MDT) Flow
...
| Boot Source | Link |
| ---------------------------------- | ---- |
| Pre-built microSD Card Image for RBF MDT Flow | [hps-first-vvp-isp-demo-image-agilex5_mk_a5e065bb32aes1.wic.gz](https://github.com/altera-fpga/agilex5-ed-camera/releases/download/rel-26.1-isp_hdr-MDK_RevC_GrpB/hps-first-vvp-isp-demo-image-agilex5_mk_a5e065bb32aes1.wic.gz) |
| Pre-built HPS First `.rbf` file | [top.core.rbf](https://github.com/altera-fpga/agilex5-ed-camera/releases/download/rel-26.1-isp_hdr-MDK_RevC_GrpB/top.core.rbf) |
| Pre-built `.jic` file | [top.core.jic](https://github.com/altera-fpga/agilex5-ed-camera/releases/download/rel-26.1-isp_hdr-MDK_RevC_GrpB/top.core.jic) |
