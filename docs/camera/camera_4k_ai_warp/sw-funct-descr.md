...
# 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices - Software Functional Description
...
![top-swm.](../camera_4k_resources/images/SW/VVP_ISP_SW_Top_level.png)
...
* Altera® FPGA Layer - **[meta-altera-fpga](https://github.com/altera-fpga/agilex5-ed-camera/tree/rel/26.1/sw/meta-altera-fpga)**
* Altera® FPGA OCS (Offset Capability Structure) Layer - **[meta-altera-fpga-ocs](https://github.com/altera-fpga/agilex5-ed-camera/tree/rel/26.1/sw/meta-altera-fpga-ocs)**
* Camera Layer - **[meta-vvp-isp-demo](https://github.com/altera-fpga/agilex5-ed-camera/tree/rel/26.1/sw/meta-vvp-isp-demo)**
