...
# 4K Multi-Sensor Fisheye Camera with AI Inference Solution System Example Design for Agilex™ 5 Devices - Hardware Design Functional Description

The hardware design for the 4K Multi-Sensor Fisheye Camera with AI Inference
...
![top_block_diagram.](../camera_4k_ai_warp/images/HW/top_block_diagram.png)
...
Example Design (as instantiated from the [AGX_5E_Modular_Devkit_ISP_AI_WARP_RD.xml](https://github.com/altera-fpga/agilex5-ed-camera/blob/rel/26.1/AGX_5E_Altera_Modular_Dk_ISP_designs/AGX_5E_Modular_Devkit_ISP_AI_WARP_RD.xml)
file) are described in greater detail below.

<br/>
<center markdown="1">

![pd_top](../camera_4k_ai_warp/images/HW/pd_top.png)
...
![pd_board](../camera_4k_ai_warp/images/HW/pd_board.png)
...
![pd_clocks](../camera_4k_ai_warp/images/HW/pd_clocks.png)
...
![pd_hps](../camera_4k_ai_warp/images/HW/pd_hps.png)
...
![pd_hps_block_diagram](../camera_4k_ai_warp/images/HW/pd_hps_block_diagram.png)
...
![pd_ocs](../camera_4k_ai_warp/images/HW/pd_ocs.png)
...
![pd_mipi_in](../camera_4k_ai_warp/images/HW/pd_mipi_in.png)
...
![pd_mipi_in_block_diagram](../camera_4k_ai_warp/images/HW/pd_mipi_in_block_diagram.png)
...
![pd_isp_in](../camera_4k_ai_warp/images/HW/pd_isp_in.png)
...
![pd_isp_in_block_diagram](../camera_4k_ai_warp/images/HW/pd_isp_in_block_diagram.png)
...
![pd_isp](../camera_4k_ai_warp/images/HW/pd_isp.png)
...
![pd_isp_block_diagram](../camera_4k_ai_warp/images/HW/pd_isp_block_diagram.png)
...
image path into the same FPGA DDR4 SDRAM.
Reference should be made to the
[ISP AI Functional Description.](../camera_4k_ai_warp/isp-ai-funct-descr.md) when reading this
...
![pd_ai](../camera_4k_resources/images/HW/pd_ai.png)
...
![pd_ai_block_diagram](../camera_4k_resources/images/HW/pd_ai_block_diagram.png)
...
Example Design. The full resolution image path outputs to the
[VID_Out Subsystem](#vid_out-subsystem).
...
store the image into the same external FPGA DDR4 SDRAM for the FPGA AI Suite
...
![pd_fpga_ai_suite](../camera_4k_resources/images/HW/pd_fpga_ai_suite.png)
...
![pd_ai_niosv](../camera_4k_resources/images/HW/pd_ai_niosv.png)
...
![pd_emif](../camera_4k_ai_warp/images/HW/pd_emif.png)
...
![pd_vid_out](../camera_4k_ai_warp/images/HW/pd_vid_out.png)
...
![pd_vid_out_block_diagram](../camera_4k_ai_warp/images/HW/pd_vid_out_block_diagram.png)
...
![pd_dp_tx](../camera_4k_ai_warp/images/HW/pd_dp_tx.png)
...
![qpds_flow_summary](../camera_4k_ai_warp/images/HW/qpds_flow_summary.png)
...
![qpds_hierarchy](../camera_4k_ai_warp/images/HW/qpds_hierarchy.png)
...
![qpds_fmax](../camera_4k_ai_warp/images/HW/qpds_fmax.png)
...
![qpds_design_closure](../camera_4k_ai_warp/images/HW/qpds_design_closure.png)
