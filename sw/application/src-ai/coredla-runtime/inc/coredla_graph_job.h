...
class CoreDlaGraphJob : public GraphJob {
 public:
  ...
  // Thread safe
  std::shared_ptr<BatchJob> GetBatchJob();
  CoreDlaGraphJob(const CoreDlaGraphJob& other) = delete;
  CoreDlaGraphJob& operator=(const CoreDlaGraphJob& other) = delete;
  CoreDlaGraphJob(CoreDlaGraphJob&& other) = delete;
  CoreDlaGraphJob& operator=(CoreDlaGraphJob&& other) = delete;
 ...
 private:
  ...
  std::vector<std::shared_ptr<BatchJob>> batchJobs_;
