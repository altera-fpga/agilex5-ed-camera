...
/**
 * \brief Register map definitions for the Video & Vision Processing WBC Intel FPGA IP
 *
 * Register map definitions for the Video & Vision Processing WBC Intel FPGA IP
