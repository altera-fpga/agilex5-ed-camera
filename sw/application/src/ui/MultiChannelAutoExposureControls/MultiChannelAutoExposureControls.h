...
class MultiChannelAutoExposureControls : public IpUiControls
{
public:
    /// Creates an instance of the class that'll manage the given Switch instance.
    MultiChannelAutoExposureControls(const std::shared_ptr<SwApi::MultiChannelAutoExposure>& spMultiChannelAutoExposure);
    ...
    std::string GetSettingsSectionName() override { return "MultiChannelAutoExposure"; };
