...
namespace SwUtils
{
    ...
    std::shared_ptr<std::vector<uint8_t>> IFile::Load(const std::filesystem::path& filename)
    {
    ...
    std::shared_ptr<std::vector<std::string>> IFile::LoadStrings(const std::filesystem::path& filename)
    {
