...
/**
 * \brief   Common read/write driver accessor defines for the Intel VVP FPGA IP Suite
 *
...
typedef void __iomem *intel_vvp_core_base;
 ...
 */
#define INTEL_VVP_CORE_REG_IORD(instance, reg)          ioread32( (void __iomem *)( (uint32_t __iomem *)( (intel_vvp_core_instance*)(instance) )->base + (reg) ) )
 ...
 * \pre        reg must be a valid register offset for the given vvp_core instance
 */
#define INTEL_VVP_CORE_REG_IOWR(instance, reg, value)   iowrite32( (value), (void __iomem *)((uint32_t __iomem *)( (intel_vvp_core_instance*)(instance) )->base + (reg) ) )
